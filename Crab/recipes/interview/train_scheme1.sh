...
# Training Script for Interview 3-Class System (Scheme 1: Valence-Based Hard Mapping)
...
SAVE_DIR="/home/brant/Project/SAILER_test/Crab/experiments/interview_scheme1"
...
echo "=========================================================="
echo "Starting Training: Interview 3-Class (Scheme 1)"
